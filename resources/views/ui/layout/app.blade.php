            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-6 text-center" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <h2><span>I'm </span><span class="underlight">{{ $user->nama_lengkap }}</span> a Professional<span>
                ...
                <div class="row gy-4 justify-content-center">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="gallery-item h-100">
                            <img src="{{ asset('porto/assets/img/gallery/gallery-1.jpg') }}" class="img-fluid" alt="">
                            <div class="gallery-links d-flex align-items-center justify-content-center">
                                <a href="{{ asset('porto/assets/img/gallery/gallery-1.jpg') }}" title="Gallery 1"
